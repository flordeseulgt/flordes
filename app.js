...
const PRODUCTS = [
  {
    ...
    nameLong: 'B:Lab Matcha Hydrating Real Sun Stick SPF50+',
    price: 240,
    size: '21g',
    img: 'public/assets/images/marcas/blab/protectorsblab.webp',
    desc: 'Protector solar en barra hidratante con extracto de té matcha de alta protección. Su textura ligera y refrescante se desliza suavemente sin dejar rastro blanco ni sensación grasosa.',
    tags: ['solar', 'barra', 'matcha', 'protector'],
    badge: 'new',
    categories: ['solar'],
  ...
  },
  {
    ...
    nameLong: 'Mary & May Tranexamic Acid + Glutathione Eye Cream',
    price: 160,
    size: '30g',
    img: 'public/assets/images/marcas/mary/maryandmay.webp',
    desc: 'Crema iluminadora para contorno de ojos formulada con Ácido Tranexámico y Glutatión. Ayuda a reducir visiblemente las ojeras oscuras y mejorar la firmeza de la piel.',
    tags: ['ojos', 'iluminadora', 'ojeras', 'crema'],
    badge: 'new',
